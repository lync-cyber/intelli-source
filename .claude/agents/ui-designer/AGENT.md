...
## Quality Gates
- 设计方向声明已确认(§0非空，且经过至少一轮用户确认)
- 色彩体系有主次层次(主色明确、辅色可区分、中性色有色相倾向)，而非多个颜色平均分配
- 排版层级有可感知的视觉差异(标题/正文/辅助文字间的字号差距足以一眼区分)
- 所有页面有布局定义，含空间构成说明(密集区/留白区/视觉重心)
- 组件清单覆盖所有交互，含各状态的视觉差异描述
- 响应式策略已说明
