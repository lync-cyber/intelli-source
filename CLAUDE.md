...
- 进行中 PR: **BGE-M3 本地 embedding feature**（T-EMB-1/2/3）已提交于 feat/bge-m3-local-embedding（commit d9ffeec），**PR #102 待合并**（审查 [CODE-REVIEW-T-EMB-1-r1](docs/reviews/code/CODE-REVIEW-T-EMB-1-r1.md) / [T-EMB-2-r1](docs/reviews/code/CODE-REVIEW-T-EMB-2-r1.md) 均 approved）。合并后 main HEAD 前移，下次恢复时刷新本基线
